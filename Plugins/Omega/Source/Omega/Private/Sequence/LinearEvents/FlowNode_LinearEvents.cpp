...
#include "Sequence/LinearEvents/FlowNode_LinearEvents.h"
...
void UFlowNode_LinearEvents::GetGeneralDataText_Implementation(const FString& Label, const UObject* Context, FText& Name, FText& Description)
{
    Name        = NodeName;
