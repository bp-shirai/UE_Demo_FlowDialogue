...
#include "Sequence/Event/OmegaLinearEventInstance.h"
#include "Data/Parser/OmegaDataParserSubsystem.h"
...
void UOmegaLinearEventSubsystem::Local_NewEvent(UOmegaLinearEventInstance* Instance, int32 EventIndex, UOmegaLinearEvent* Event)
{
...
UOmegaLinearEventInstance* UOmegaLinearEventSubsystem::PlayLinearEvent(FLinearEventSequence Sequence, int32 StartingEvent)
{
    ...
    TempEventInst->OnEventSequenceFinish.AddDynamic(this, &ThisClass::Local_EndEvent);
    TempEventInst->OnEventUpdated.AddDynamic(this, &ThisClass::Local_NewEvent);
