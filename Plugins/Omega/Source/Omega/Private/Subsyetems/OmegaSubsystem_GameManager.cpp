...
void UOmegaGameManager::Initialize(FSubsystemCollectionBase& Collection)
{
//#if !PLATFORM_ANDROID
...
void UOmegaGameManager::OnLevelChanged(UWorld* World, const UWorld::InitializationValues)
{

}

UOmegaGameManager::UOmegaGameManager()
{
