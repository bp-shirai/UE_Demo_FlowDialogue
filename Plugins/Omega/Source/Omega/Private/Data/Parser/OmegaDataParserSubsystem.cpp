...
UOmegaDataParserReader* UOmegaDataParserSubsystem::ParseDataFromString(TSubclassOf<UOmegaDataParserReader> ReaderClass, const FString& String)
{
...
UOmegaDataParserReader* UOmegaDataParserSubsystem::ParseDataFromPath(TSubclassOf<UOmegaDataParserReader> ReaderClass, const FString& Path)
{
    FString FileContent;
