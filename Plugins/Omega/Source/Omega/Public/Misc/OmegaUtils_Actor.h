...
UCLASS()
class OMEGA_API UOmegaActorUtilFunctions : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
...
class OMEGA_API UOmegaActorSelector : public UObject
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION()
    TArray<AActor*> Private_GetActorList(UWorld* WorldContext);
};
