...
class UQueuedLinearEventInterface : public UInterface
{
    GENERATED_BODY()
};
class OMEGA_API IQueuedLinearEventInterface
{
    GENERATED_BODY()
public:
...
class OMEGA_API UOmegaLinearEventSubsystem : public UWorldSubsystem
{
    GENERATED_BODY()
...
private:
    UPROPERTY()
    TArray<UObject*> Queued_event_sources;
...
class OMEGA_API UOmegaLinearEventScriptReader : public UObject
{
    GENERATED_BODY()
...
UINTERFACE(MinimalAPI)
class UDataInterface_EventSequence : public UInterface
{
    GENERATED_BODY()
};

class OMEGA_API IDataInterface_EventSequence
{
    GENERATED_BODY()
public:
