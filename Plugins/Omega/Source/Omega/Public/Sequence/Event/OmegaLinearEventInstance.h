...
class OMEGA_API UOmegaLinearEventInstance : public UObject
{
    GENERATED_BODY()

    UFUNCTION()
    void on_EventEnd(UOmegaLinearEvent* Event, const FString& Flag);
...
public:
    ...
    UFUNCTION()
    void StartEvent(UOmegaLinearEvent* Event, const FString& Flag);
};
