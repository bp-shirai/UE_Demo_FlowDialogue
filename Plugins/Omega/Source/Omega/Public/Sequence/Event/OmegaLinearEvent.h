...
class OMEGA_API UOmegaLinearEvent : public UObject
{
    GENERATED_BODY()
public:
    ...
    UFUNCTION(BlueprintPure, Category = "LinearEvent|Guid")
    FGuid GetEventGuid()
    {
    ...
    UPROPERTY(BlueprintAssignable, Category = "LinearEvent")
    FOnEventBegin EventBegin;
    ...
    UFUNCTION()
    virtual void Native_Begin(const FString& Flag = "");
...
class OMEGA_API UOmegaLinearEventReader : public UObject
{
    GENERATED_BODY()
...
UCLASS()
class OMEGA_API UOmegaLinearEventFunctions : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
