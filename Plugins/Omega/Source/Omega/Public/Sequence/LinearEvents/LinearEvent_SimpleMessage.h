...
class OMEGA_API ULinearEvent_SimpleMessage : public UOmegaLinearEvent, public IDataInterface_General
{
    GENERATED_BODY()
...
class OMEGA_API UFlowNode_SimpleMessage : public UFlowNode, public IDataInterface_General
{
    GENERATED_BODY()
