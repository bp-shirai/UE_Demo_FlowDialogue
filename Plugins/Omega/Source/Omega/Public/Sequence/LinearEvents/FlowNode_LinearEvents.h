...
class OMEGA_API UFlowNode_LinearEvents : public UFlowNode, public IDataInterface_General, public IGameplayTagsInterface
{
    GENERATED_BODY()
...
public:
    ...
    UPROPERTY(EditAnywhere, Category = "General", meta = (MultiLine))
