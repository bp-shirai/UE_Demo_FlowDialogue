...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnNewLevel, FString, LevelName, AGameMode*, GameMode);
...
class OMEGA_API UOmegaGameManager : public UGameInstanceSubsystem
{
    GENERATED_BODY()
public:
    UOmegaGameManager();
...
public:
    ...
    // UPROPERTY()
    // FOmegaGlobalVarsContainer GlobalVars;
