 ...
 */
UCLASS()
class OMEGA_API UDialogueTextBlock : public URichTextBlock
{
    GENERATED_BODY()
...
struct OMEGA_API FDialogueTextSegment
{
    FString Text;
...
UCLASS()
class OMEGA_API UDialogueBox : public UUserWidget
{
    GENERATED_BODY()
...
private:
    ...
    public:
        ...
        void setCurrentLetterIndex(int32 idx)
        {
