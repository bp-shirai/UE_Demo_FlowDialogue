...
class UDataInterface_ObjectHierarchy : public UInterface
{
    GENERATED_BODY()
};

class OMEGA_API IDataInterface_ObjectHierarchy
{
    GENERATED_BODY()
public:
...
class OMEGA_API IDataInterface_General
{
    GENERATED_BODY()
public:
...
UINTERFACE(MinimalAPI)
class UDataInterface_GUID : public UInterface
{
    GENERATED_BODY()
};
class OMEGA_API IDataInterface_GUID
{
    GENERATED_BODY()
public:
...
class OMEGA_API IGameplayTagsInterface
{
    GENERATED_BODY()
public:
